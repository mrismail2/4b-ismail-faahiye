...
export const STRINGS = {
  ...
  quranProgress: { en: "Qur'an Progress", so: "Horumarka Qur'aanka" },
  ...
  heroSubtitle: {
    en: 'Kobciye gives schools, teachers and parents one trusted place to manage students, attendance, payments, exams and Qur\'an progress — and to spot students who need support, early.',
    so: 'Kobciye waxay dugsiyada, macallimiinta iyo waalidiinta siisaa hal goob lagu kalsoonaan karo si loo maamulo ardayda, xaadiriska, lacag-bixinta, imtixaannada iyo horumarka Qur\'aanka — oo lagu ogaado ardayda u baahan taageero, goor hore.',
  },
